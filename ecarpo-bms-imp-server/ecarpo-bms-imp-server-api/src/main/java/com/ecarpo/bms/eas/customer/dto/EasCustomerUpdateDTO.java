 ...
 */
package com.ecarpo.bms.eas.customer.dto;
...
@Data
public class EasCustomerUpdateDTO extends UpdateDTO {
  ...
  private List<EasOrgRangeDTO> orgRanges;

  private List<EasSubOrgRangeDTO> subOrgRanges;
