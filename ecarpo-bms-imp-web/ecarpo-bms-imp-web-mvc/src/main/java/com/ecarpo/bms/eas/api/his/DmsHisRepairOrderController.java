 ...
 */
@RestController
@RequestMapping("/api/dms/import/dms_his_repair_order")
public class DmsHisRepairOrderController {
  ...
  public Object insert(@Valid @RequestBody DmsHisRepairOrderInsertDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
    return service.insert(dto);
  }

  @RequestMapping(value = "update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
  public Object update(@Valid @RequestBody DmsHisRepairOrderUpdateDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
