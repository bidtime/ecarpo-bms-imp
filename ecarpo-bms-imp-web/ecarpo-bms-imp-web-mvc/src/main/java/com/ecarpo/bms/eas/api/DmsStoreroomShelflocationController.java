 ...
 */
@RestController
@RequestMapping("/api/dms/import/dms_storeroom_shelflocation")
public class DmsStoreroomShelflocationController {
  ...
  public Object insert(@Valid @RequestBody DmsStoreroomShelflocationInsertDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
    return service.insert(dto);
  }

  @RequestMapping(value = "update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
  public Object update(@Valid @RequestBody DmsStoreroomShelflocationUpdateDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
