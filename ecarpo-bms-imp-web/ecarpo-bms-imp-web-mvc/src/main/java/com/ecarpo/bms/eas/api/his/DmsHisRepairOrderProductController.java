 ...
 */
@RestController
@RequestMapping("/api/eas/DmsHisRepairOrderProduct")
public class DmsHisRepairOrderProductController {
  ...
  public Object insert(@Valid @RequestBody DmsHisRepairOrderProductInsertDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
    return service.insertLong(dto);
  }

  @RequestMapping(value = "update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
  public Object update(@Valid @RequestBody DmsHisRepairOrderProductUpdateDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
