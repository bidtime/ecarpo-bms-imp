package com.ecarpo.bms.eas.api.his;
 ...
 */
@RestController
@RequestMapping("/api/dms/import/dms_his_repair_order_workhours")
public class DmsHisRepairOrderWorkhoursController {
  ...
  public Object insert(@Valid @RequestBody DmsHisRepairOrderWorkhoursInsertDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
    return service.insert(dto);
  }

  @RequestMapping(value = "update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
  public Object update(@Valid @RequestBody DmsHisRepairOrderWorkhoursUpdateDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
