 ...
 */
@RestController
@RequestMapping("/api/dms/import/crm_member_car")
public class CrmMemberCarController {
  ...
  public Object update(@Valid @RequestBody CrmMemberCarUpdateDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
