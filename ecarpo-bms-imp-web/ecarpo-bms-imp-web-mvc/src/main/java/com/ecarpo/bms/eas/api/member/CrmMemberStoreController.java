...
import com.ecarpo.bms.eas.server.crmmemberstore.service.CrmMemberStoreService;
...
public class CrmMemberStoreController {
  ...
  @Autowired
  private CrmMemberStoreService service;
  ...
  public Object update(@Valid @RequestBody CrmMemberStoreUpdateDTO dto, UserLoginBO user) throws Exception {
    UserUtils.copy(dto, user);
